...
import { Container, BackLine, CardWrapper, NumberAnalyticRow } from './styles';
...
export default function User() {
  ...
  const userData = useUserOnPageLoad({ username });
        ...
        <div className="columns">
          ...
          <div className="column col-sm-12 col-8">
            <CardWrapper>
              ...
              form, by injected humour, or randomised words w
            </CardWrapper>
          </div>
        </div>
      </div>
